...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |CTL/ESC|  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return |PgUp|
   * |----------------------------------------------------------------|
...
[_FL] = KEYMAP_ANSI(
  ...
  _______,_______,_______,BL_DEC, BL_TOGG,BL_INC, _______,_______,_______,_______,_______,KC_MPLY, KC_VOLU, KC_MUTE, \
